...
const FourPostThreeStackP = () => {
  const download1 = "../assets/images/two_post_3_lvl_card.png";
  const download2 = null;
  const data = {
    title: "4 Post 3 Level Stack Parking System",
    description_1:
  ...
  return (
    <>
      ...
      <div className="bg-[#3C3C3C0D]">
        <ProductDescription data={data} row={'lg:flex-row-reverse'} />
        <FeaturesBenefits features={features} benefit={null} row={'lg:flex-row-reverse'} />
      </div>
...
export default FourPostThreeStackP;
